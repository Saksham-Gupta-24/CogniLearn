...
customization_options = {
        ...
        "Generation_type": st.sidebar.selectbox("Generation Type", ["Text", "Image"])
        #"Generation_type": st.sidebar.multiselect("Generation Type", ["Text", "Image"])
    }


st.title("🧠 CogniLearn - Empowering Minds, Powered by AI!. ")
